...
class InterestFreeLoanAgreement(BaseDocumentGenerator):
    ...
    def docx_to_pdf(self, docx_path, pdf_path):
        print(pdf_path)
        pdfmetrics.registerFont(TTFont("DejaVuSans", "src/templates/multipage_docs/Arial/arial.ttf"))
        pdfmetrics.registerFont(TTFont("DejaVuSans-Bold", "src/templates/multipage_docs/Arial/arial_bold.ttf"))
        pdfmetrics.registerFont(TTFont("DejaVuSans-Italic", "src/templates/multipage_docs/Arial/arial_italic.ttf"))
    ...
    def _generate_one_sample(self):
        context = {
            ...
            "org_reason": random.choice(
                ["устава компании", "договоренности", "решения учредителей", "договора", "протокола собрания"]
            ),
